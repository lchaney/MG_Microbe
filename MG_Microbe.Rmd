...
##Data Exploration
We have a lot of variables, but we don't want to test them all. Let us see if we can narrow down our focus.
...
```{r boxplots, echo=FALSE, results='hide', warning=FALSE, cache=TRUE}
  lapply(samplevars, gxe_potgrid2)
...
##Differences in selection by treatment
