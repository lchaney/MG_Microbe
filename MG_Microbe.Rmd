...
Treatments are: (1) Antibiotic, (2) Inoculum, (3) Field, (4) Autoclave
...
```{r, doffqaud, echo = TRUE}
doff.quad
```

What does the joint selection of Flowering Day and Size look like?
...
```{r, sg ancova, echo = TRUE}
    anova(asgl)
    anova(asgq)
```


Difference is quadratic selection of Flowering Time by treatment

```{r, sg quad treat, echo = TRUE}
